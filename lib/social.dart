...
class ExpandedTopicsPage extends StatefulWidget {
  const ExpandedTopicsPage({super.key});

  @override
  ExpandedTopicsPageState createState() => ExpandedTopicsPageState();
}

class ExpandedTopicsPageState extends State<ExpandedTopicsPage> {
                              ...
                              child: Text.rich(
                                  TextSpan(
                                      children: [
                                        ...
                                        TextSpan(
                                          text: '\n\nBy recognizing the impact of housing and '
                                              'neighborhood quality on social outcomes, stakeholders can '
                                              'make informed decisions that promote the well-being of all '
                                              'residents. This includes investing in affordable housing, '
                                              'improving infrastructure, promoting community engagement, '
                                              'and fostering a sense of belonging and pride in neighborhoods.',
...
class DraggableScrollableContentIntroduction extends StatelessWidget {
  final ScrollController scrollController;

   DraggableScrollableContentIntroduction({super.key, required this.scrollController});
            ...
            child: Padding(
                ...
                child: Text.rich(
                    TextSpan(
                        ...
                        'has broader social and environmental impacts. The players in the real estate market include '
                        ...
                        'This market reaches an optimal balance (where all players benefit without harming others)'
                         ...
                         'price. However, most buyers purchase items like fruit, tables, or bicycles for personal use, '
                          'not for resale or rent. This means that real estate has both consumer demand and investment '
                           ...
                           'vary significantly in size, features, and quality. For instance, luxurious 1,000 square '
                           'meter homes and low-quality 40 square meter apartments coexist in this market, which '
                           'economically are not homogeneous goods. This heterogeneity complicates the analysis of '
                           'supply and demand in the market. In the following sections, we will examine the problems '
                           'and solutions for both the supply and demand sides of the real estate market. After these '
                           'sections, we will look at the professions created by the real estate market. The goal is '
                           'to gain a broader understanding of the real estate market and its extensive impacts on the '
                            'economy and society by examining its characteristics. '
                            ...
                            'market, the focus in this program is on the buying and selling market. However, there is '
                             ...
                             'and selling market. The real estate buying and selling market is influenced by factors '
                            ...
                            ' resources. However, some of the content, especially in the \'Market Impact\' '
                ...
                TextSpan(
                  ...
                  TextSpan(
                    text: '\n\nThe real estate demand refers to the total '
                        'number of properties that buyers have the desire and '
                  ...
                  TextSpan(
                    text: '\n▶ The demand for properties either residential or commercial'
                  ...
                  TextSpan(
                    text: '\n\n4. Property Quality: Luxury vs. Economic Properties',
                    style: TextStyle(
                      fontSize: textFontSize,
                      fontWeight: FontWeight.bold, color: Colors.blue,
                    ),
                  ...
                  TextSpan(
                    text: '\n▶ The increased demand for larger properties '
                        ...
                        'prices of small to medium-sized propertiesdemand for small to'
    ...
    fontSize: textFontSize,
            ...
            style: TextStyle(
              fontSize: textFontSize,
                  ...
                  TextSpan(
                    text: '\n\n\n4. Demand Differences by Property Quality: Luxury vs. Economic Properties',
                    style: TextStyle(
                      fontWeight: FontWeight.bold, color: Colors.pink, fontSize: titleFontSize,
                    ),
                  ),
                      ...
                      TextSpan(
                        ...
                        style: TextStyle(
                          ...
                          fontWeight: FontWeight.bold, color: Colors.blue,
                                          ...
                                          TextSpan(
                          text: '\n\nSupply in the real estate market refers to the total number of building units that their owners are willing and able to offer for sale over a given period, assuming all other factors remain constant. To gain a deeper understanding of the characteristics of the supply side of the real estate market, we can examine them from various perspectives, as outlined below,',
                          style: TextStyle(
                            fontSize: textFontSize,
                          ),
                        ),
...
class EconomicsOfConstructionPageState extends State<EconomicsOfConstructionPage> {
  ...
  bool _supplySideExpanded = false;
  bool _demandSideExpanded = false;
                  ...
                  child: Column(
                    ...
                    children: [
                       SizedBox(height: 2 * spacingHeight),
                          ...
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text( 'Economy and Real Estate Market',
                       ...
                       SizedBox(height: spacingHeight),
                          ...
                          SizedBox(width:buttonWidth,
                            child: ElevatedButton(
                                onPressed: () {
                                  setState(() {
                                    _introductionEconomics = !_introductionEconomics;
                                     _jobOpportunitiesExpanded = false;
                                     _supplySideExpanded = false;
                                     _demandSideExpanded = false;
                      ...
                      if (_introductionEconomics)
                        SizedBox(height:screenHeight * 0.6,
                          child: DraggableScrollableContentIntroduction(scrollController: _scrollControllerEco
                          ),
                        ),
                       SizedBox(height: spacingHeight),
                      ...
                      SizedBox(width:buttonWidth,
                            child: ElevatedButton(
                                onPressed: () {
                                  setState(() {
                                    _demandSideExpanded = !_demandSideExpanded;
                                    _supplySideExpanded = false;
                                    _jobOpportunitiesExpanded = false;
                                    _introductionEconomics = false;
                                              _referencesExpanded = false;
                                  });
                                },
                                style: ElevatedButton.styleFrom(
                        ...
                        if (_demandSideExpanded)
                         SizedBox(height:screenHeight * 0.6,
                            child: DraggableScrollableContentDemand(scrollController: _scrollControllerEco
                            ),
                          ),
                       SizedBox(height: spacingHeight),
                      ...
                      SizedBox(width:buttonWidth,
                            child: ElevatedButton(
                                onPressed: () {
                                  setState(() {
                                    _supplySideExpanded = !_supplySideExpanded;
                                    _jobOpportunitiesExpanded = false;
                                    _introductionEconomics = false;
                                    _demandSideExpanded = false;_referencesExpanded = false;
                                  });
                                },
                                style: ElevatedButton.styleFrom(
                                  foregroundColor: const Color.fromRGBO(
                      ...
                      if (_supplySideExpanded)
                        SizedBox(height:screenHeight * 0.6,
                          child: DraggableScrollableContentSupply(scrollController: _scrollControllerEco
                          ),
                        ),
                       SizedBox(height: spacingHeight),
